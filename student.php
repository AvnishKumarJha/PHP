<html>
<head>
<title>Registration With CSS</title>
<style>
.main
{
width: 40%;
...
.maininput[type="text", .main input[type="email"]
{
width: 40%;
border: 1px solid black;
padding: .5em;
...
<h2>Bharti vidhyapeeth (Deemed to be University) College of Engineering Pune</h2>
